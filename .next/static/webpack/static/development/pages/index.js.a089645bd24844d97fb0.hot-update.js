...
/* harmony import */ var _babel_runtime_corejs2_core_js_promise__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! @babel/runtime-corejs2/core-js/promise */ "./node_modules/@babel/runtime-corejs2/core-js/promise.js");
/* harmony import */ var _babel_runtime_corejs2_core_js_promise__WEBPACK_IMPORTED_MODULE_15___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_corejs2_core_js_promise__WEBPACK_IMPORTED_MODULE_15__);
...
/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ../store */ "./store.js");
/* harmony import */ var _components_examples__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ../components/examples */ "./components/examples.js");
/* harmony import */ var _index_js__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ../index.js */ "./index.js");
/* harmony import */ var _index_css__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./index.css */ "./pages/index.css");
/* harmony import */ var _index_css__WEBPACK_IMPORTED_MODULE_25___default = /*#__PURE__*/__webpack_require__.n(_index_css__WEBPACK_IMPORTED_MODULE_25__);
...
var getlist = function getlist(url, param) {
  return new _babel_runtime_corejs2_core_js_promise__WEBPACK_IMPORTED_MODULE_15___default.a(function (resolve, reject) {
    _store__WEBPACK_IMPORTED_MODULE_22__["Axios"].post(url, param).then(function (res) {
...
function (_React$Component) {
  ...
  function Index() {
    ...
    _this = Object(_babel_runtime_corejs2_helpers_esm_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_10__["default"])(this, (_getPrototypeOf2 = Object(_babel_runtime_corejs2_helpers_esm_getPrototypeOf__WEBPACK_IMPORTED_MODULE_11__["default"])(Index)).call.apply(_getPrototypeOf2, [this].concat(args)));

    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_14__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_12__["default"])(_this), "getlist_gold", function (obj) {
      var _this$props = _this.props,
          dispatch = _this$props.dispatch,
          params_gold = _this$props.params_gold;
      dispatch(Object(_store__WEBPACK_IMPORTED_MODULE_22__["getGoldList"])(_objectSpread({}, params_gold, {}, obj)));
    });

    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_14__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_12__["default"])(_this), "getlist_git", function (obj) {
      var _this$props2 = _this.props,
          dispatch = _this$props2.dispatch,
          params_git = _this$props2.params_git;
      dispatch(Object(_store__WEBPACK_IMPORTED_MODULE_22__["getGitList"])(_objectSpread({}, params_git, {}, obj)));
    });

    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_14__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_12__["default"])(_this), "handleChange", function (category) {
      console.log("selected ".concat(category));
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_14__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_12__["default"])(_this), "HOTc", function (order) {
      _this.getlist_gold({
        order: order
      });
    });

    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_14__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_12__["default"])(_this), "handlecategoryChange", function (category) {
      _this.getlist_git({
        category: category
      });
    });

    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_14__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_12__["default"])(_this), "handleperiodChange", function (period) {
      _this.getlist_git({
        period: period
      });
    });

    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_14__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_12__["default"])(_this), "handlelangChange", function (lang) {
      _this.getlist_git({
        lang: lang
      });
    });
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_9__["default"])(Index, [{
    ...
    value: function componentDidMount() {
      var _this$props3 = this.props,
          ...
          GOLD_LIST = _this$props3.GOLD_LIST,
          GIT_LIST = _this$props3.GIT_LIST; // this.timer = startClock(dispatch)
    ...
    value: function render() {
      ...
      var _this$props4 = this.props,
          GOLD_LIST = _this$props4.GOLD_LIST,
          state = _this$props4.state,
          GIT_LIST = _this$props4.GIT_LIST,
          params_gold = _this$props4.params_gold,
          params_git = _this$props4.params_git;
      console.log(state);
      return __jsx(antd_lib_layout__WEBPACK_IMPORTED_MODULE_17___default.a, {
      ...
      }, __jsx(antd_lib_select__WEBPACK_IMPORTED_MODULE_19___default.a, {
        ...
        value: "trending"
      }, "\u70ED\u95E8")), __jsx(antd_lib_select__WEBPACK_IMPORTED_MODULE_19___default.a, {
        defaultValue: "day",
        style: {
          width: 100
        },
        ...
        value: "month"
      }, "\u672C\u6708"))), __jsx("div", null, __jsx(antd_lib_select__WEBPACK_IMPORTED_MODULE_19___default.a, {
    ...
    value: function getInitialProps(_ref) {
      ...
      var _reduxStore$getState = reduxStore.getState(),
          params_gold = _reduxStore$getState.params_gold,
          params_git = _reduxStore$getState.params_git;

      reduxStore.dispatch(Object(_store__WEBPACK_IMPORTED_MODULE_22__["serverRenderClock"])(isServer));
      var p1 = getlist('https://extension-ms.juejin.im/resources/gold', params_gold);
      var p2 = getlist('https://extension-ms.juejin.im/resources/github', params_git);
      return _babel_runtime_corejs2_core_js_promise__WEBPACK_IMPORTED_MODULE_15___default.a.all([p1, p2]).then(function (result) {
        //['成功了', 'success']
        reduxStore.dispatch(Object(_store__WEBPACK_IMPORTED_MODULE_22__["changGoldList"])(result[0]));
        reduxStore.dispatch(Object(_store__WEBPACK_IMPORTED_MODULE_22__["changGitList"])(result[1]));
        return {
      ...
      return _store__WEBPACK_IMPORTED_MODULE_22__["Axios"].post('https://extension-ms.juejin.im/resources/gold', {
        category: "frontend",
        limit: 30,
        offset: 0,
        order: "time"
        ...
        var data = res.data.data;
        reduxStore.dispatch(Object(_store__WEBPACK_IMPORTED_MODULE_22__["changGoldList"])(data));
        return {
          GOLD_LIST: reduxStore.getState()['GOLD_LIST']
        };
      });
...
//# sourceMappingURL=index.js.a089645bd24844d97fb0.hot-update.js.map